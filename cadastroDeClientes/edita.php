              ...
              <div class='row'>
                <div class='col-md-8 d-flex mb-4 mt-5 mt-md-0 text-black mx-auto'>
                    <div class='align-self-center mx-auto card'>
                      <form class='form card-body' action='salvar.php?nome=". $pesquisa ."' method='POST'>
                        <input type='hidden' name='id' value='". $id ."'/>
                        <div class='entrada'>
                          Nome: <input name='nome' value='". $nome ."' type='text' class='form-control input' placeholder='Nome' required/>
                        </div>
  
                        <div class='entrada'>
                          Email: <input name='email' value='". $email ."' type='email' class='form-control input' placeholder='E-mail' required/>
                        </div>
  
                        <div class='entrada'>
                          Telefone: <input name='telefone' value='". $telefone ."' type='tel' class='form-control input' placeholder='Telefone' required/>
                        </div>

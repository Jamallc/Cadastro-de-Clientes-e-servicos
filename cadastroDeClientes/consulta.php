    ...
    <section class="bg-light pt-4 shadow">   
        ...
        <div class="row">
          <div class="col-md-12 d-flex mb-4 mt-5 mt-md-0 text-black mx-auto">
              <div class="align-self-center mx-auto">
                <form class="form2" action="consulta.php" method="GET">
                  <div class="entrada">
                    Nome: <input name="nome" type="text" class="form-control input" placeholder="Nome" required/>
                  </div>

                  <button type="submit" class="btn btn-primary btn-lg btn-block">Buscar Cliente</button>
                </form>
              </div>
          </div>
        </div>
                ...
                <div class="card-body">
                  <div class="entrada2">  
                    ...
                    <tr> 
                      ...
                      <td><?php echo date('d/m/Y', strtotime($dado['data_cadastro'])) . "<br>"; ?></td> 
                      <td> 
                        <a class="btn btn-success" href="descricao.php?codigo=<?php echo $dado['id']; ?>">Descrição</a> 
                        <a class="btn btn-warning" href="edita.php?codigo=<?php echo $dado['id']; ?>&nome=<?php echo $_SESSION["pesquisa"] ?>">Editar</a> 
                        <a class="btn btn-danger" href="exclui.php?codigo=<?php echo $dado['id']; ?>">Excluir</a> 
                      </td> 
                    </tr>
                    <?php } ?> 
                    </table>
      ...
      <?php 
        ...
        <div class="d-flex mb-5">
          <div class="col-md-5 alert alert-danger mx-auto" role="alert">
